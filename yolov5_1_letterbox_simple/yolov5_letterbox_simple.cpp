 ...
 * 
 *  
 * This version use simplest letterboxing.
 * (1) Create a black sqaure background.
 * (2) Copy the original image to the top-left corner
 * (3) Resize it to 640*640
 *
...
int main(int argc, char **argv)
{
    ...
    std::string output_file = "../output_cpp_letterbox_simple.jpg";
